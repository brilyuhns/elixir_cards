...
IO.puts Conditions.clause_with_guards({4, 5, 6})
IO.puts "--------"
IO.puts "Conditions.case_without_else({4, 5, 6}) would throw an error if match does not exist"
IO.puts Conditions.case_without_else({4, 5, 6})
IO.puts "--------"
